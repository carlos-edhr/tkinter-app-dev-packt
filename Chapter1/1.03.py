...
my_menu_button = tk.Menubutton(my_menu_bar, text="Menu tk.Button Widget 1",)
...
menu_button_2 = tk.Menubutton(my_menu_bar, text="Menu 2",)
...
# scale widget
tk.Scale(
    my_frame_2, from_=0.0, to=100.0, label="Scale widget", orient=tk.HORIZONTAL
).pack()

# LabelFrame
label_frame = tk.LabelFrame(my_frame_2, text="LabelFrame Widget", padx=10, pady=10)
