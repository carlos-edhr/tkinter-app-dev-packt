import os
from tkinter import Tk, PhotoImage, Menu, Frame, Text, Scrollbar, IntVar, StringVar, END
...
edit_menu.add_command(
    label="Undo", accelerator="Ctrl+Z", compound="left", image=undo_icon, command=undo
)
edit_menu.add_command(
    label="Redo", accelerator="Ctrl+Y", compound="left", image=redo_icon, command=redo
)
edit_menu.add_separator()
edit_menu.add_command(
    label="Cut", accelerator="Ctrl+X", compound="left", image=cut_icon, command=cut
)
edit_menu.add_command(
    label="Copy", accelerator="Ctrl+C", compound="left", image=copy_icon, command=copy
)
edit_menu.add_command(
    label="Paste",
    accelerator="Ctrl+V",
...
edit_menu.add_separator()
edit_menu.add_command(
    label="Select All", underline=7, accelerator="Ctrl+A", command=select_all
)
...
view_menu.add_checkbutton(
    label="Highlight Current Line", onvalue=1, offvalue=0, variable=highlight_line
)
